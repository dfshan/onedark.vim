...
let s:colors = {
      ...
      \ "black": get(s:overrides, "black", { "gui": "#282C34", "cterm": "0", "cterm16": "0" }),
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#2C323C", "cterm": "239", "cterm16": "8" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#3E4452", "cterm": "242", "cterm16": "15" }),
